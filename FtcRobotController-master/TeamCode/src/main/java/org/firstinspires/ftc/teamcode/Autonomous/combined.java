  ...
  // private DcMotor         rightDrive  = null;
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftfrontTarget = _leftFront.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newRightfrontTarget = _rightFront.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);
            newLeftbackTarget = _leftBack.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newRightbackTarget = _rightBack.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);
